...
Spirit commands are managed in a Config Plugin: js/plugins/config/active/SRW_SpiritManager.js
...
These abilities and effects are managed in a Config Plugin: js/plugins/config/active/SRW_AbilityManager.js
